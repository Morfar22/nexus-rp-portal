...
-- Set all created_by and user reference fields to NULL to avoid foreign key violations
...
UPDATE achievements SET created_by = NULL WHERE created_by IS NOT NULL;
