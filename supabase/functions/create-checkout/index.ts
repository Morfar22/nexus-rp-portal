      ...
      line_items: [
        {
          price_data: {
            ...
            recurring: { interval: packageData.interval },
          },
          quantity: 1,
        },
      ],
      mode: "subscription",
      success_url: `${req.headers.get("origin")}/packages?success=true`,
      cancel_url: `${req.headers.get("origin")}/packages?canceled=true`,
    });
