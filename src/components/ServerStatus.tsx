  ...
  if (servers.length === 0) {
    return (
      <Card className="p-8 bg-gaming-card/50 border-gaming-border text-center">
        ...
        <h3 className="text-lg font-semibold text-muted-foreground mb-2">No Servers Configured</h3>
        <p className="text-sm text-muted-foreground">
          Configure your servers in the Server Management panel to display them here.
        </p>
      </Card>
    );
  }
