...
import DiscordStaffSync from './DiscordStaffSync';
...
const DiscordBotManager = ({ 
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Traditional Role Management */}
      <Card className="bg-gaming-card border-gaming-border">
        <CardHeader>
          <CardTitle className="text-foreground">Discord Role Management</CardTitle>
        </CardHeader>
