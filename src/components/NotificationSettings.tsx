...
import { Bell, Volume2, Mail, Smartphone, Settings } from "lucide-react";
  ...
  return (
    <Card className="p-6 bg-gaming-card border-gaming-border">
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Show browser notifications for new chats and messages
                </p>
              </div>
            </div>
            <Switch
          ...
          {!hasPermission && settings.desktop && (
            <div className="ml-7 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              <p className="text-sm text-yellow-600">
                Desktop notifications are disabled in your browser. 
                <Button 
                  variant="link" 
        ...
        {/* <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Smartphone className="h-4 w-4 text-neon-teal" />
            <div>
              <Label className="text-foreground font-medium">Push Notifications</Label>
              <p className="text-sm text-muted-foreground">
                Receive push notifications when away from the page
              </p>
            </div>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Send email alerts for missed chats and important events
              </p>
            </div>
          </div>
          <Switch
        ...
        <div className="space-y-2">
          <Label className="text-foreground font-medium">Away Timeout (minutes)</Label>
          <p className="text-sm text-muted-foreground">
            How long before you're considered away from the page
          </p>
          <Input
            type="number"
            min="1"
