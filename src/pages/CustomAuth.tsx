...
// Error boundary wrapper for auth context
    ...
    const handleDiscordCallback = async () => {
      ...
      if (code) {
        ...
        try {
          ...
          if (data.success && data.data.sessionToken && data.data.customUser) {
            // Store session token
            localStorage.setItem('custom_session_token', data.data.sessionToken);
            
            toast({
              title: "Welcome!",
              description: `Successfully signed in with Discord as ${data.data.customUser.username}!`,
            });
